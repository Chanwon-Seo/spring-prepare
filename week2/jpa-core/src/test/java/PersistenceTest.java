...
public class PersistenceTest {
    ...
    void test8() {
        ...
        try {
            ...
            System.out.println("\n수정을 진행합니다.");
            memo.setUsername("Update111");
            memo.setContents("변경 감지 확인111");

            Memo findMemo = em.find(Memo.class, 4);
            System.out.println("memo.getId() = " + findMemo.getId());
            System.out.println("memo.getUsername() = " + findMemo.getUsername());
            System.out.println("memo.getContents() = " + findMemo.getContents());
